...
function App() {
  ...
  return (
    <>
      ...
      <div className='border-2 flex  gap-4 items-center  parent border-black  h-screen   pl-2 pt-4 pb-4 mx-1'>



        <div className='part-1 border  border-red-600 h-full overflow-y-auto  w-[420px]'>
        ...
        <div className='part-2 border  border-red-600 h-full overflow-y-auto  w-[420px]'>
        ...
        <div className='part-3 border  border-red-600 h-full overflow-y-auto  w-[420px]'>
