...
function App() {
  ...
  return (
    <>
      ...
      <div className='border-2 flex  gap-4 items-center  parent border-black  h-screen w-full  pl-2 pt-4 pb-4 mx-1'>



        <div className='part-1  border border-red-600 h-full overflow-y-auto flex-grow-0 flex-shrink-0 basis-[420px]'>
          ...
          <div className='child-2 px-2 py-4 w-[400px] border border-red bg-gray-100 '>
          ...
          <div className='child-3 px-2 py-4 w-[400px] border border-red bg-gray-100 '>
          ...
          <div className='child-4 px-2 py-4 w-[400px] border border-red bg-gray-100 '>
        ...
        <div className='part-2  border border-red-600 h-full overflow-y-auto flex-grow-0 flex-shrink-0 basis-[420px]'>
        ...
        <div className='part-3  border border-red-600 h-full overflow-y-auto flex-grow-0 flex-shrink-0 basis-[420px]'>
        ...
        <div className='part-4  border border-red-600 h-full overflow-y-auto flex-grow-0 flex-shrink-0 basis-[420px]'>
